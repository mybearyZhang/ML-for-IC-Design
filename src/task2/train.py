...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir', type=str, default='data/task2/', help='Directory containing the data files.')
    ...
    parser.add_argument('--best_model_path', type=str, default='best_model_task2.pth', help='Path to save the best model.')
    parser.add_argument('--project_name', type=str, default='GNN-IC-Design-Task2', help='Project name for wandb logging.')
